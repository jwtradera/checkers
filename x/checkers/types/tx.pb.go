...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "jwtradera.checkers.checkers.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "jwtradera.checkers.checkers.MsgCreatePostResponse")
}
...
var fileDescriptor_b89f7ca8d0309536 = []byte{
	...
	0x2a, 0x2f, 0x29, 0x4a, 0x4c, 0x49, 0x2d, 0x4a, 0xd4, 0x83, 0x49, 0xc2, 0x19, 0x4a, 0xc1, 0x5c,
	...
	0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x74, 0x2b, 0x19, 0x92, 0x65, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jwtradera.checkers.checkers.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jwtradera.checkers.checkers.Msg/CreatePost",
	}
